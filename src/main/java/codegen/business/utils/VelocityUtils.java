package codegen.business.utils;

import codegen.business.GenConstants;
...
public class VelocityUtils
{
    ...
    public static String getFileName(String template, GenTable genTable)
    {
        ...
        {
            fileName = StringUtils.format("{}/pojo/entity/{}.java", javaPath, className);
        ...
        {
            fileName = StringUtils.format("{}/web/rest/{}Controller.java", javaPath, className);
